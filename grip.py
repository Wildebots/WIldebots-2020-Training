...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [67.62589835434508, 93.99317406143345]
        self.__hsv_threshold_saturation = [83.47122433374253, 255.0]
        self.__hsv_threshold_value = [68.70503793946273, 255.0]
