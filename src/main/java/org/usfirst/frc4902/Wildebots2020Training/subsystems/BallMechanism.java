...
public class BallMechanism extends Subsystem {
    ...
    private PWMVictorSPX ballRoller;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public BallMechanism() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ballRoller = new PWMVictorSPX(1);
        addChild("Ball Roller",ballRoller);
        ballRoller.setInverted(false);
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new BallCollect_DropOff());
