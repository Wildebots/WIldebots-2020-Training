...
public class OI {
    ...
    public OI() {
        ...
        my_Xbox360Controller = new Joystick(0);
        
        joystickButtonY = new JoystickButton(my_Xbox360Controller, 4);
        joystickButtonY.whileHeld(new RaiseGripper());
        joystickButtonA = new JoystickButton(my_Xbox360Controller, 1);
        joystickButtonA.whileHeld(new LowerGripper());
    ...
    public Joystick getmy_Xbox360Controller() {
